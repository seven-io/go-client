...
func (api *RcsResource) dispatch(ctx context.Context, p interface{}) (*string, error) {
...
func (api *RcsResource) delete(ctx context.Context, id uint) (*string, error) {
